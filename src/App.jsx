    ...
    <>
      <div className='resume_container'>
        ...
        <div className='resume_sections_container'>
          ...
          <ResumeSection isBuild = {false} headline={<CodingProjectTitle projectTitle={'Nosea'} frontendHyperlink={'https://github.com/davilasergio/nosea-frontend'} backendHyperlink={'https://github.com/davilasergio/nosea-backend'}/>} summary={<CodingProjectSummary summary={`First serious JavaScript/React project, an extremely basic chat app. Introduced me to the basics of React and the interactions between the frontend and backend of a project, while strengthening my skills in various JavaScript concepts such as developing an API, fetch requests, and UX/UI design.
`}/>}>
            <CodingProjectStack>
